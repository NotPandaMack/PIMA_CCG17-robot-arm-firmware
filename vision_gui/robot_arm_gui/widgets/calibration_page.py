...
class CalibrationPage(QWidget):
    ...
    def _table_z_step(self) -> QWidget:
        ...
        self.side_stream_url.setPlaceholderText("DesktopGUI WHIP URL for Larix")
        self.side_stream_url.setReadOnly(True)
        button_row = QHBoxLayout()
        start_button = QPushButton("Use WebRTC Side Camera")
        ...
        stream_layout.addWidget(QLabel("Side View / iPhone WebRTC Camera"))
