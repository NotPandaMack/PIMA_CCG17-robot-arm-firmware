...
class TestPage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        jogs = [
            ("X-", "IKMOVE:-1.20:0.00:0.00:0.00"),
            ("X+", "IKMOVE:1.20:0.00:0.00:0.00"),
            ("Y-", "IKMOVE:0.00:-1.20:0.00:0.00"),
            ("Y+", "IKMOVE:0.00:1.20:0.00:0.00"),
            ("Z-", "IKMOVE:0.00:0.00:-1.00:0.00"),
            ("Z+", "IKMOVE:0.00:0.00:1.00:0.00"),
            ("Pitch-", "IKMOVE:0.00:0.00:0.00:-0.60"),
            ("Pitch+", "IKMOVE:0.00:0.00:0.00:0.60"),
        ]
        for index, (label, command) in enumerate(jogs):
            button = QPushButton(label)
            button.clicked.connect(lambda _checked=False, cmd=command: self.command_requested.emit(cmd))
            jog_layout.addWidget(button, index // 2, index % 2)
